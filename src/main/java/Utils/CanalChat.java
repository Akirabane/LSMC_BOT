...
public class CanalChat extends ListenerAdapter {
    ...
    public void onReady(ReadyEvent event) {
        ...
        EmbedBuilder embed = new EmbedBuilder()
                ...
                .setDescription("Je suis heureux de pouvoir répondre à vos questions et de vous aider. Utilisez la commande /help afin d'obtenir des informations sur les commandes disponibles.")
